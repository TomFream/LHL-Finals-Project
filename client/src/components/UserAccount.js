      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8} lg={9}>
          ...
          <Card className={classes.userInfoBox}>
            <Typography className={classes.userTextInfoText} variant={"h6"}>
              Name: {user.name}
            </Typography>
            <Typography className={classes.userTextInfoText} variant={"h6"}>
            ...
            <Typography className={classes.userTextInfoText} variant={"h6"}>
              Power Level: {user.powerLevel}
            </Typography>
            <Typography className={classes.userTextInfoText} variant={"h6"}>
              Favorite Activity: {user.favoriteActivity}
            </Typography>
            <Typography className={classes.userTextInfoText} variant={"h6"}>
              Known Web Technologies: {user.knownTech}
            </Typography>
          </Card>
        </Grid>
        <Grid item xs={12}>
